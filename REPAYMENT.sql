...
CREATE OR REPLACE PROCEDURE TUMRPACPMB001.ADD_PAYMENT_DATE
...
BEGIN
  ...
  --  v_INTERVAL_COUNT := INTERVAL_TYPE(p_INTEREST_PERIOD_FREQUENCY);
 ...
 p_CUSTODY_ACCOUNT_KEY, v_PAYMENT_DATE, p_NOMINAL_EUR_VAL, p_AMOUNT_EUR_VAL,
