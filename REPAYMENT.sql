CREATE OR REPLACE FUNCTION KOKO1.AMORTIZATION_TYPE_TR (
...
CREATE OR REPLACE FUNCTION KOKO1.FIRST_PAYMENT_DATE (
...
CREATE OR REPLACE FUNCTION KOKO1.LAST_PAYMENT_DATE (
	p_ACTUAL_DATE IN  T_DM_ABS_POSITION_A.ACTUAL_DATE%TYPE,
	p_LEGAL_MATURITY_DATE IN  T_DM_ABS_POSITION_A.LEGAL_MATURITY_DATE%TYPE,
	p_EXPECTED_MATURITY_DATE IN  T_DM_ABS_POSITION_A.EXPECTED_MATURITY_DATE%TYPE
)
...
CREATE OR REPLACE FUNCTION KOKO1.GET_QUARTER (p_date IN DATE)
RETURN NUMBER
IS
	v_QUARTER NUMBER;
	v_MONTH NUMBER;
...
CREATE OR REPLACE FUNCTION KOKO1.GET_MONTH (p_date IN DATE)
RETURN NUMBER
IS
	v_MONTH NUMBER;
BEGIN
...
CREATE OR REPLACE FUNCTION KOKO1.GET_YEAR (p_date IN DATE)
RETURN NUMBER
IS
	v_YEAR NUMBER;
BEGIN
